...
export const getArchivePasswords = () => service.get('/admin/archive-passwords', adminRequest)
export const addArchivePassword = (password) => service.post('/admin/archive-passwords', { password }, adminRequest)
export const deleteArchivePassword = (id) => service.delete(`/admin/archive-passwords/${id}`, adminRequest)
