...
services:
  ...
  app:
    ...
    environment:
      ...
      FEISHU_SUPER_ADMIN_OPEN_IDS: ${FEISHU_SUPER_ADMIN_OPEN_IDS:-}
      FEISHU_SUPER_ADMIN_NAMES: ${FEISHU_SUPER_ADMIN_NAMES}
      MAX_UPLOAD_BYTES: "2147483648"
      MAX_FILES_PER_UPLOAD: ${MAX_FILES_PER_UPLOAD:-100}
      MAX_EXTRACT_BYTES: "8589934592"
      MAX_PARSE_WORKERS: ${MAX_PARSE_WORKERS:-2}
      MAX_AI_WORKERS: ${MAX_AI_WORKERS:-1}
      MAX_PARSE_ATTEMPTS: ${MAX_PARSE_ATTEMPTS:-3}
      MAX_PARSE_PER_USER: ${MAX_PARSE_PER_USER:-1}
      MAX_PARSE_PER_PROJECT: ${MAX_PARSE_PER_PROJECT:-2}
      MAX_FILES_PER_PARSE_TASK: ${MAX_FILES_PER_PARSE_TASK:-10000}
      MAX_BYTES_PER_PARSE_TASK: ${MAX_BYTES_PER_PARSE_TASK:-8589934592}
      HTTP_READ_HEADER_TIMEOUT_SECONDS: ${HTTP_READ_HEADER_TIMEOUT_SECONDS:-10}
      HTTP_READ_TIMEOUT_SECONDS: ${HTTP_READ_TIMEOUT_SECONDS:-1800}
      HTTP_WRITE_TIMEOUT_SECONDS: ${HTTP_WRITE_TIMEOUT_SECONDS:-600}
      HTTP_IDLE_TIMEOUT_SECONDS: ${HTTP_IDLE_TIMEOUT_SECONDS:-120}
      HTTP_SHUTDOWN_TIMEOUT_SECONDS: ${HTTP_SHUTDOWN_TIMEOUT_SECONDS:-30}
...
# 外包账号登录无需 Redis、SMTP 或额外密钥；数据库迁移会自动创建凭证表。
