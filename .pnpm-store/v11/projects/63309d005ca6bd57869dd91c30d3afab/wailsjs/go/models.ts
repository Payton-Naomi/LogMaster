export namespace main {
	...
	export class CatalogTask {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.allProjects = source["allProjects"];
	        this.applicableProjects = source["applicableProjects"];
	    }
	...
	export class CatalogKeywordGroupInput {
	    profileId: string;
	    id: string;
	    name: string;
	    scope: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new CatalogKeywordGroupInput(source);
	    }
	...
	export class CatalogKeywordProfileInput {
	    id: string;
	    name: string;

	    static createFrom(source: any = {}) {
	        return new CatalogKeywordProfileInput(source);
	    }
	...
	export class CatalogKeywordRuleInput {
	    profileId: string;
	    groupId: string;
	    id: string;
	    name: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new CatalogKeywordRuleInput(source);
	    }
	...
	export class CatalogProjectInput {
	    ...
	    static createFrom(source: any = {}) {
	        return new CatalogProjectInput(source);
	    }
	...
	export class CatalogTaskInput {
	    ...
	    static createFrom(source: any = {}) {
	        return new CatalogTaskInput(source);
	    }
	...
	export class EditableConfigFileDTO {
	    name: string;
	    content: string;

	    static createFrom(source: any = {}) {
	        return new EditableConfigFileDTO(source);
	    }
	...
	export class UploadTaskDTO {
	    ...
	    static createFrom(source: any = {}) {
	        return new UploadTaskDTO(source);
	    }
	...
	export class UploadQueuePageDTO {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.items = this.convertValues(source["items"], UploadTaskDTO);
	        this.total = source["total"];
	    }
	...
	export class UploadTaskActionResult {
	    succeeded: number;
	    skipped: number;
	    failed: number;

	    static createFrom(source: any = {}) {
	        return new UploadTaskActionResult(source);
	    }
